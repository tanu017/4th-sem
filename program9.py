...
time_used = end - start
print(f"Brute force result: {brute_force_result:.2f}, time_used: {time_used:.6f} seconds")
start = time.time()
horners_rule_result = hornersRule(coef, n, x)
end = time.time()
time_used = end - start
print(f"Horner's rule result: {horners_rule_result:.2f}, time_used: {time_used: .6f} seconds")  
